...
import { deletePartition, describeDiskFailure } from "@/lib/server/modules/system/disk-service";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { status, message } = describeDiskFailure(error, "Failed to delete partition");
